...
for p = 1:nb_of_simu
    ...
    for k=1:N-1
        ...
        if (x(1,k+1,p)<=0.11) && (x(3,k+1,p)<=0.11) && (x(1,k+1,p)>=0.09) && (x(3,k+1,p)>=0.09) %test de position 2 si lobstacle 1  reached
            x(13,k+1,p)=0.1;
            x(14,k+1,p)=0.2;
            %disp(x(:,k+1,p));
            s=k+2
        ...
        if (x(1,k+1,p)<=0.11) && (x(3,k+1,p)<=0.21) && (x(1,k+1,p)>=0.09) && (x(3,k+1,p)>=0.09)
          x(2,k+1,p)=0;
        %  x(5,k+1,p)=1;% a vérifier
        end
